...
export default function Grade9PresentPerfectActivity() {
  ...
  useEffect(() => {
  const allIndexes = Array.from(presentPerfectSentences.keys());
  ...
  useEffect(() => {
    ...
    const rawQuestion = presentPerfectSentences[questionOrder[currentIndex]];
...
const handleDragEnd = useCallback((event) => {
  ...
  return (
    ...
    >
      <ActivityContainer>
        <ActivityHeader title={t("activities.grade9.presentPerfectActivity.title")}
                                     description={t("activities.grade9.presentPerfectActivity.description")}/>
        <ScoreCounter
