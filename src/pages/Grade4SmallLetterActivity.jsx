...
export default function Grade4SmallLettersActivity() {
  ...
  const handleOptionClick = (option) => {
    ...
    const correct = option.small === currentQuestion.small;
    setFeedback(correct);
  ...
  return (
    <ActivityContainer>
      <ActivityHeader title={t("activities.grade4.smallLettersActivity.title")}
                           description={t("activities.grade4.smallLettersActivity.description")}/>
